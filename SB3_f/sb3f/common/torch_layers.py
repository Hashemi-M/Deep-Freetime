...
from sb3f.common.preprocessing import get_flattened_obs_dim, is_image_space
from sb3f.common.type_aliases import TensorDict
...
def create_mlp(
    ...
    '''
    # Replace last layer of modules
    final_layer = modules[-2]
    # Setting Wight range
