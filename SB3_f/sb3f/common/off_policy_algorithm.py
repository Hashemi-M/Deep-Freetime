...
from sb3f.common.base_class import BaseAlgorithm
from sb3f.common.buffers import DictReplayBuffer, ReplayBuffer
from sb3f.common.callbacks import BaseCallback
from sb3f.common.noise import ActionNoise, VectorizedActionNoise
from sb3f.common.policies import BasePolicy
from sb3f.common.save_util import load_from_pkl, save_to_pkl
from sb3f.common.type_aliases import GymEnv, MaybeCallback, RolloutReturn, Schedule, TrainFreq, TrainFrequencyUnit
from sb3f.common.utils import safe_mean, should_collect_more_steps
from sb3f.common.vec_env import VecEnv
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def _convert_train_freq(self) -> None:
        ...
        """
        if not isinstance(self.train_freq, TrainFreq) or not isinstance(self.train_freq, TrainFrequencyUnit):
    ...
    def collect_rollouts(
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            # Select action randomly or according to policy
            # TODO implement freetime action selection
