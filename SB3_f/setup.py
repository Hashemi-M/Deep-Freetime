...
with open(os.path.join("sb3f", "version.txt")) as file_handler:
...
setup(
    name="sb3f",
    packages=[package for package in find_packages() if package.startswith("sb3f")],
    package_data={"sb3f": ["py.typed", "version.txt"]},
    install_requires=[
