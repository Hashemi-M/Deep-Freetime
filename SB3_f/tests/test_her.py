...
from sb3f import DDPG, DQN, SAC, TD3, HerReplayBuffer
from sb3f.common.envs import BitFlippingEnv
...
from sb3f.her.her_replay_buffer import get_time_limit


def test_import_error():
    with pytest.raises(ImportError) as excinfo:
        from sb3f import HER
