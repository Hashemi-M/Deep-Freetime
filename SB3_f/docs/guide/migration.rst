...
In most cases, replacing ``from stable_baselines`` by ``from sb3f`` will be sufficient.
...
.. code-block:: python
  ...
  from sb3f.common.env_util import make_atari_env, make_vec_env
  from sb3f.common.utils import set_random_seed

instead of ``from sb3f.common import make_atari_env``
...
.. warning::
	...
	Use ``sb3f.common.sb2_compat.rmsprop_tf_like.RMSpropTFLike`` optimizer to match the results
